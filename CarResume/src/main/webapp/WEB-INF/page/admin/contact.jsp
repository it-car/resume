                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <form id="list-form" method="post" action="${ctx}/contact/admin">
                            <!-- 页码 加到input，这是一个技巧。因为form表单不会提交a标签的内容，只会提交input select textear 等的表单标签的内容。-->
                                    ...
                                    <div class="search-box input-group">
                                        ...
                                        <div class="form-line input">
                                            <input type="date" name="beginDay"
                                                   value="<fmt:formatDate value="${result.beginDay}" pattern="yyyy-MM-dd" />"
                                                   class="form-control" placeholder="开始日期">
                                        </div>
                                        <div class="form-line input">
                                            <input type="date" name="endDay"
                                                   value="<fmt:formatDate value="${result.endDay}" pattern="yyyy-MM-dd" />"
                                        ...
                                        <div class="form-line keyword">
                                            <input type="text" value="${result.keyword}" name="keyword" class="form-control" placeholder="主题、内容等">
                                        </div>
