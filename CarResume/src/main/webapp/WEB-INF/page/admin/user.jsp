...
<%--                                  --%>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-9 col-xs-9">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text"value="${user.name}" id="name" name="name" maxlength="20" class="form-control" placeholder="姓名">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-9 col-xs-9">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" value="${user.job}" id="job" name="job" maxlength="20" class="form-control" placeholder="工作">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-9 col-xs-9">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" value="${user.phone}" id="phone" name="phone" maxlength="20" class="form-control" placeholder="电话">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-9 col-xs-9">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input id="trait" value="${user.trait}" name="trait" maxlength="100" type="text" class="form-control" data-role="tagsinput"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-9 col-xs-9">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text"
                                                   value="${user.address}"
                                                   id="address" name="address" maxlength="100" class="form-control" placeholder="住址">
                                        </div>
                                    </div>
                                </div>
                            </div>
