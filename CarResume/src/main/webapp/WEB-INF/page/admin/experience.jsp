                                    ...
                                    <form id="remove-form" method="post" action="${ctx}/experience/remove">
                                        <c:forEach items="${experiences}" var="experience">
                                            <tr>
                                                ...
                                                <td><fmt:formatDate value="${experience.beginDay}" pattern="yyyy-MM-ss"></fmt:formatDate></td>
                                                <td><fmt:formatDate value="${experience.endDay}" pattern="yyyy-MM-ss"></fmt:formatDate></td>
