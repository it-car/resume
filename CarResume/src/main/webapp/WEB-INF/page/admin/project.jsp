                                    ...
                                    <form id="remove-form" method="post" action="${ctx}/project/remove">
                                        <c:forEach items="${projects}" var="project">
                                            <tr>
                                                ...
                                                <td><fmt:formatDate value="${project.beginDay}" pattern="yyyy-MM-ss"></fmt:formatDate></td>
                                                <td><fmt:formatDate value="${project.endDay}" pattern="yyyy-MM-ss"></fmt:formatDate></td>
                                                <td>${project.intro}</td>
                                                <td>
